...
if __name__=='__main__':
    ...
    str = "\t\t\t\tcout << (" + str(r[0][0]) + "*CPos(0, 3) + " + str(r[1][0]) + "*CPos(1, 3) + " + str(r[2][0]) + "*CPos(2, 3))*" + str(s) + " << \" \";\n"    \
        + "\t\t\t\tcout << (" + str(r[0][1]) + "*CPos(0, 3) + " + str(r[1][1]) + "*CPos(1, 3) + " + str(r[2][1]) + "*CPos(2, 3))*" + str(s) + " << \" \";\n"    \
        + "\t\t\t\tcout << (" + str(r[0][2]) + "*CPos(0, 3) + " + str(r[1][2]) + "*CPos(1, 3) + " + str(r[2][2]) + "*CPos(2, 3))*" + str(s) + " << \" \";"
    f = open('test2.txt', 'w+')
    f.write(str)
    f.close()
